...
export const CLIENT_API_URL = "https://client.api.basta.wtf/graphql";
export const WS_CLIENT_API_URL = "wss://client.api.basta.wtf/graphql";
export const MANAGEMENT_API_URL = "https://management.api.basta.wtf/graphql";
